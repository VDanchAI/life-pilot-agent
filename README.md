# life-pilot-agent
AI life management system designed by a practicing psychologist
# Life Pilot Agent
...
Проект начинался как форк [smixs/agent-second-brain](https://github.com/smixs/agent-second-brain) и вырос в отдельный продукт:

| Функция | Оригинал | Life Pilot |
|---|---|---|
| Философия дизайна | Tech-first | Psychology-first |
| Интеграция с Google Calendar | ❌ | ✅ Утренний план с расписанием |
| Автоматический ритм дня | ❌ | ✅ Утренний план + вечерний отчёт |
| Недельный дайджест + коучинг | ❌ | ✅ Обзор прогресса с вопросами |
| GROW-коучинг | ❌ | ✅ Неделя / месяц / квартал / год |
| Месячное планирование | ❌ | ✅ Сессия целей через вопросы |
| Управление задачами | Базовое | Устаревание, переносы, обновления |
| Сортировка по проектам | Общая папка | Мульти-проектная классификация |
| Интерактивные кнопки | Базовые | 7 кнопок с полными воркфлоу |
| Исправление ошибок | — | Множество скрытых багов исправлено |
| Качество кода | — | ruff 0 ошибок, mypy strict 0 ошибок |
